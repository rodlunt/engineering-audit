...
```
claude mcp add engineering-audit -- uvx --from git+https://github.com/rodlunt/engineering-audit@v0.10.0 engineering-audit-mcp --rules-dir <path-to-rules-clone>
```

`@v0.10.0` pins the install to the current tagged release rather than the moving `main` branch;
