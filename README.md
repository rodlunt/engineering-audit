...
Every command below is pinned to the current release tag (`@v0.9.0`) rather than the
...
```sh
claude mcp add engineering-audit -- uvx --from git+https://github.com/rodlunt/engineering-audit@v0.9.0 \
...
```sh
uvx --from git+https://github.com/rodlunt/engineering-audit@v0.9.0 engineering-audit-fragments \
...
```json
{
  "mcpServers": {
    "engineering-audit": {
      ...
      "args": [
        "--from",
        "git+https://github.com/rodlunt/engineering-audit@v0.9.0",
